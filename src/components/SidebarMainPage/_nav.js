    ...
    items: [
        {
            ...
            children: [
                {
                    name: 'Badania i analizy rynku',
                    url: 'https://emmerson.pl/pl/article/1/badania-i-analizy-rynku',
                    icon: 'fa fa-file',
                },
                {
                    name: 'Zarządzanie nieruchomościami',
                    url: 'http://emmerson-zarzadzanie.pl/',
                    icon: 'fa fa-home',
                },
                {
                    name: 'Aranżacja i wyposażenie wnętrz',
                    url: 'http://emmerson-zarzadzanie.pl/aranzacje-i-wykonczenia/',
                    icon: 'fa fa-image',
                },
                {
                ...
                {
                    name: 'Inwestowanie w nieruchomości',
                    url: 'http://www.grupaemmerson.pl/',
                    icon: 'fa fa-building',
                },
                {
                ...
                {
                    name: 'Wyceny nieruchmości',
                    url: 'http://www.emmerson-evaluation.pl/',
                    icon: 'fa fa-usd',
                }
            ]
        },
